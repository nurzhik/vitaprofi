    ...
    var modal = $('.modal_div'); // Р Р†РЎРѓР Вµ РЎРѓР С”РЎР‚РЎвЂ№РЎвЂљРЎвЂ№Р Вµ Р СР С•Р Т‘Р В°Р В»РЎРЉР Р…РЎвЂ№Р Вµ Р С•Р С”Р Р…Р В°
         ...
         overlay.fadeIn(400, //Р С—Р С•Р С”Р В°Р В·РЎвЂ№Р Р†Р В°Р ВµР С Р С•Р Р†Р ВµРЎР‚Р В»РЎРЊР в„–
             function(){ // Р С—Р С•РЎРѓР В»Р Вµ Р С•Р С”Р С•Р Р…РЎвЂЎР В°Р Р…Р С‘РЎРЏ Р С—Р С•Р С”Р В°Р В·РЎвЂ№Р Р†Р В°Р Р…Р С‘РЎРЏ Р С•Р Р†Р ВµРЎР‚Р В»РЎРЊРЎРЏ
                 $(div) // Р В±Р ВµРЎР‚Р ВµР С РЎРѓРЎвЂљРЎР‚Р С•Р С”РЎС“ РЎРѓ РЎРѓР ВµР В»Р ВµР С”РЎвЂљР С•РЎР‚Р С•Р С Р С‘ Р Т‘Р ВµР В»Р В°Р ВµР С Р С‘Р В· Р Р…Р ВµР Вµ jquery Р С•Р В±РЎР‰Р ВµР С”РЎвЂљ
                     .css('display', 'block') 
                     .animate({opacity: 1, }, 200); // Р С—Р В»Р В°Р Р†Р Р…Р С• Р С—Р С•Р С”Р В°Р В·РЎвЂ№Р Р†Р В°Р ВµР С
         });
     });
     ...
     close.click( function(){ // Р В»Р С•Р Р†Р С‘Р С Р С”Р В»Р С‘Р С” Р С—Р С• Р С”РЎР‚Р ВµРЎРѓРЎвЂљР С‘Р С”РЎС“ Р С‘Р В»Р С‘ Р С•Р Р†Р ВµРЎР‚Р В»РЎРЊРЎР‹
            modal // Р Р†РЎРѓР Вµ Р СР С•Р Т‘Р В°Р В»РЎРЉР Р…РЎвЂ№Р Вµ Р С•Р С”Р Р…Р В°
             .animate({opacity: 0, }, 200, // Р С—Р В»Р В°Р Р†Р Р…Р С• Р С—РЎР‚РЎРЏРЎвЂЎР ВµР С
...
$('#feedback-name').on('keypress', function() {
    var that = this;
...
$('.mask-phone').on('keypress', function() {
    var that = this;
...
jQuery(document).ready(function() {
 $('.catalog-item').click(function () {
        ...
        $('.catalog-box').find('.catalog-box__item').eq(itemCount).addClass('active').siblings().removeClass('active');
});
 $('.catalog-menu__item').click(function () {
  ...
  $('.product-slider__small-item').click(function () {
        var itemCount = $(this).index();
        $(this).addClass('active').siblings().removeClass('active');
...
$(document).ready(function() {
    ...
    if ($search.hasClass('active')){
        ...
        $(".search-icon > img" ).attr("src","/img/search.svg");
    }else{
        $search.addClass('active');
        $(".search-icon > img" ).attr("src","/img/close.svg");
    }
 });
  
   

     $('.lang-select__current').click(function(e) {
    var $mob_lang = $('.lang-select__list');
    ...
    $('.lang-select__option').click(function () {
        var optionValue = $(this).data('id');
        var titleValue = $(this).html();
        var thisValue = $('.lang-select__current').html();
        $('.lang_m-select__input').val(optionValue).change();
        $('.lang-select__current').html(titleValue);
        // destroy
        $(this).remove();
